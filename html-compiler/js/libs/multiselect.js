...
if (multipleOptionSelect.length > 0) {
    ...
    multipleOptionSelect.forEach(select => {
        ...
        multipleSelectorAutoSuggest.setAttribute('placeholder', 'Click here to select option.');
    ...
    multiSelectorAutoSuggestInput.forEach(autoSuggestInput => {
        autoSuggestInput.addEventListener('keyup', function (e) {
            ...
            if (this.value.match(/[,]/g)) {
                ...
                if (this.parentElement.children[0].childElementCount < 5) {
                ...
                if (!alreadyMultiDataListedArray.includes(thisCommaCleanedValue) && (this.parentElement.children[0].childElementCount < 5)) {
                    this.parentElement.children[0].appendChild(multipleSelectorOptionElementAutoSuggestSpan);
                }

                if (this.parentElement.children[0].childElementCount <= 8) {
